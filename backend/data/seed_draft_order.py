...
KEEPERS = [
    ...
    ("John Gibbons",   16, "Lawrence Butler",       "2nd yr", 671732),
    ("John Gibbons",   25, "Nick Kurtz",            "1st yr", 701762),
    ("Bryan Lewis",     5, "Kyle Schwarber",        "1st yr", 656941),
    ("Bryan Lewis",     9, "Freddy Peralta",        "1st yr", 642547),
    ("Bryan Lewis",    15, "Paul Skenes",           "3rd yr", 694973),
    ("Bryan Lewis",    21, "Nick Pivetta",           "1st yr", 601713),
