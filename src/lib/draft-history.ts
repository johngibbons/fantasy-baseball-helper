...
export const KEEPER_HISTORY: KeeperHistory[] = [
  ...
  },
  {
    ...
    entries: [
      { year: 2022, manager: 'Russell Berry', roundCost: 14, seasonsKept: 1 },
      { year: 2023, manager: 'Russell Berry', roundCost: 14, seasonsKept: 1 },
      { year: 2024, manager: 'Russell Berry', roundCost: 9, seasonsKept: 2 },
    ],
  },
  // ── 3-season keepers ──
  {
    ...
    entries: [
      { year: 2023, manager: 'Russell Berry', roundCost: 25, seasonsKept: 1 },
      { year: 2024, manager: 'Russell Berry', roundCost: 20, seasonsKept: 2 },
      { year: 2025, manager: 'Russell Berry', roundCost: 15, seasonsKept: 2 },
      { year: 2026, manager: 'Russell Berry', roundCost: 15, seasonsKept: 2 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      ...
      { year: 2024, manager: 'Russell Berry', roundCost: 2, seasonsKept: 1 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2026, manager: 'Russell Berry', roundCost: 25, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Cristopher Sanchez',
    entries: [
      { year: 2026, manager: 'Russell Berry', roundCost: 23, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Ezequiel Tovar',
    entries: [
      { year: 2026, manager: 'Russell Berry', roundCost: 19, seasonsKept: 1 },
    ],
  },
  {
