...
export const TEAM_MANAGER: Record<number, string> = {
  ...
  2: 'Russell Berry',      // BOOM – You're F****** Out
...
export interface KeeperHistoryEntry {
  ...
  manager: string
  roundCost: number
  /** Which season of an unbroken keeper run this is.
   * null for 2015 and 2016, whose sheets predate the Seasons Kept column —
   * a run that began before 2015 cannot be reconstructed from the workbook. */
  seasonsKept: number | null
}
...
export const KEEPER_HISTORY: KeeperHistory[] = [
  // Generated by backend/scripts/generate_keeper_history.py
  // from backend/data/fixtures/league_history/keepers_*.json.
  // Do not edit by hand -- regenerate instead. Players kept in
  // two or more seasons only, which is what the panel displays.

  // ── 6-season keepers ──
  {
    playerName: 'Aaron Judge',
    entries: [
      { year: 2018, manager: 'Matt Wayne', roundCost: 25, seasonsKept: 1 },
      { year: 2019, manager: 'Matt Wayne', roundCost: 20, seasonsKept: 2 },
      { year: 2020, manager: 'Matt Wayne', roundCost: 14, seasonsKept: 3 },
      { year: 2023, manager: 'Bryan Lewis', roundCost: 3, seasonsKept: 1 },
      { year: 2025, manager: 'Eric Mercado', roundCost: 1, seasonsKept: 1 },
      { year: 2026, manager: 'Eric Mercado', roundCost: 1, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'José Ramírez',
    entries: [
      { year: 2017, manager: 'Harris Cook', roundCost: 15, seasonsKept: 1 },
      { year: 2018, manager: 'Harris Cook', roundCost: 10, seasonsKept: 2 },
      { year: 2019, manager: 'Harris Cook', roundCost: 5, seasonsKept: 3 },
      { year: 2022, manager: 'Chris Herbst', roundCost: 2, seasonsKept: 1 },
      { year: 2023, manager: 'Bryan Lewis', roundCost: 1, seasonsKept: 2 },
      { year: 2026, manager: 'Tim Riker', roundCost: 1, seasonsKept: 1 },
    ],
  },
  ...
  // ── 5-season keepers ──
  {
    ...
    entries: [
      { year: 2015, manager: 'John Gibbons', roundCost: 1, seasonsKept: null },
      { year: 2016, manager: 'John Gibbons', roundCost: 2, seasonsKept: null },
      { year: 2017, manager: 'John Gibbons', roundCost: 2, seasonsKept: 3 },
  ...
  },
  {
    ...
    entries: [
      { year: 2015, manager: 'Jess Barron', roundCost: 5, seasonsKept: null },
      { year: 2017, manager: 'Tim Riker', roundCost: 5, seasonsKept: 1 },
      { year: 2018, manager: 'Tim Riker', roundCost: 3, seasonsKept: 2 },
      { year: 2022, manager: 'Jess Barron', roundCost: 1, seasonsKept: 1 },
      { year: 2023, manager: 'Jess Barron', roundCost: 1, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Ketel Marte',
    entries: [
      { year: 2020, manager: 'David Rotatori', roundCost: 25, seasonsKept: 1 },
      { year: 2022, manager: 'David Rotatori', roundCost: 20, seasonsKept: 2 },
      { year: 2024, manager: 'Jess Barron', roundCost: 19, seasonsKept: 1 },
      { year: 2025, manager: 'Jess Barron', roundCost: 14, seasonsKept: 2 },
      { year: 2026, manager: 'Jess Barron', roundCost: 9, seasonsKept: 3 },
    ],
  },
  {
    playerName: 'Mike Trout',
    entries: [
      { year: 2015, manager: 'Chris Herbst', roundCost: 1, seasonsKept: null },
      { year: 2016, manager: 'Chris Herbst', roundCost: 1, seasonsKept: null },
      { year: 2017, manager: 'Chris Herbst', roundCost: 1, seasonsKept: 3 },
      { year: 2019, manager: 'Bryan Lewis', roundCost: 1, seasonsKept: 1 },
      { year: 2020, manager: 'Bryan Lewis', roundCost: 1, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Shohei Ohtani',
    entries: [
      { year: 2020, manager: 'Eric Mercado', roundCost: 19, seasonsKept: 1 },
      { year: 2022, manager: 'Eric Mercado', roundCost: 14, seasonsKept: 2 },
      { year: 2023, manager: 'Eric Mercado', roundCost: 9, seasonsKept: 3 },
      { year: 2025, manager: 'Jess Barron', roundCost: 1, seasonsKept: 1 },
      { year: 2026, manager: 'Jess Barron', roundCost: 1, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Trea Turner',
    entries: [
      { year: 2017, manager: 'Eric Mercado', roundCost: 14, seasonsKept: 1 },
      { year: 2018, manager: 'Eric Mercado', roundCost: 9, seasonsKept: 2 },
      { year: 2019, manager: 'Eric Mercado', roundCost: 4, seasonsKept: 3 },
      { year: 2022, manager: 'Matt Wayne', roundCost: 1, seasonsKept: 1 },
      { year: 2023, manager: 'Matt Wayne', roundCost: 1, seasonsKept: 2 },
    ],
  },
  ...
  // ── 4-season keepers ──
  {
    ...
    entries: [
      { year: 2016, manager: 'John Gibbons', roundCost: 14, seasonsKept: null },
      { year: 2017, manager: 'John Gibbons', roundCost: 9, seasonsKept: 3 },
      { year: 2018, manager: 'John Gibbons', roundCost: 4, seasonsKept: null },
      { year: 2022, manager: 'Bryan Lewis', roundCost: 11, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Chris Sale',
    entries: [
      { year: 2015, manager: 'Chris Herbst', roundCost: 4, seasonsKept: null },
      { year: 2018, manager: 'Jess Barron', roundCost: 2, seasonsKept: 1 },
      { year: 2019, manager: 'Jess Barron', roundCost: 1, seasonsKept: 2 },
      { year: 2025, manager: 'Bryan Lewis', roundCost: 8, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Christian Yelich',
    entries: [
      { year: 2015, manager: 'Jason McComb', roundCost: 15, seasonsKept: null },
      { year: 2017, manager: 'Jess Barron', roundCost: 10, seasonsKept: 1 },
      { year: 2019, manager: 'Jason McComb', roundCost: 3, seasonsKept: 1 },
      { year: 2020, manager: 'Jason McComb', roundCost: 1, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Clayton Kershaw',
    entries: [
      { year: 2015, manager: 'Jess Barron', roundCost: 1, seasonsKept: null },
      { year: 2016, manager: 'Jess Barron', roundCost: 1, seasonsKept: null },
      { year: 2017, manager: 'Jess Barron', roundCost: 1, seasonsKept: 3 },
      { year: 2018, manager: 'Jess Barron', roundCost: 1, seasonsKept: null },
    ],
  },
  {
    playerName: 'Cody Bellinger',
    entries: [
      { year: 2018, manager: 'Harris Cook', roundCost: 23, seasonsKept: 1 },
      { year: 2019, manager: 'Harris Cook', roundCost: 18, seasonsKept: 2 },
      { year: 2020, manager: 'Harris Cook', roundCost: 13, seasonsKept: 3 },
      { year: 2024, manager: 'Jess Barron', roundCost: 18, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Fernando Tatis Jr.',
    entries: [
      { year: 2019, manager: 'Harris Cook', roundCost: 25, seasonsKept: 1 },
      { year: 2020, manager: 'Harris Cook', roundCost: 20, seasonsKept: 2 },
      { year: 2022, manager: 'Harris Cook', roundCost: 15, seasonsKept: 3 },
  ...
  },
  {
    ...
    entries: [
      ...
      { year: 2026, manager: 'Bryan Lewis', roundCost: 9, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Jose Altuve',
    entries: [
      { year: 2015, manager: 'David Rotatori', roundCost: 10, seasonsKept: null },
      { year: 2016, manager: 'Harris Cook', roundCost: 5, seasonsKept: null },
      { year: 2017, manager: 'Harris Cook', roundCost: 1, seasonsKept: 2 },
      { year: 2018, manager: 'John Gibbons', roundCost: 1, seasonsKept: null },
    ],
  },
  {
    playerName: 'Juan Soto',
    entries: [
      { year: 2020, manager: 'Jess Barron', roundCost: 3, seasonsKept: 1 },
      { year: 2022, manager: 'Jess Barron', roundCost: 1, seasonsKept: 2 },
      { year: 2023, manager: 'Jess Barron', roundCost: 1, seasonsKept: 3 },
      { year: 2026, manager: 'John Gibbons', roundCost: 1, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Manny Machado',
    entries: [
      { year: 2015, manager: 'Jason McComb', roundCost: 14, seasonsKept: null },
      { year: 2016, manager: 'Jason McComb', roundCost: 9, seasonsKept: null },
      { year: 2017, manager: 'Jason McComb', roundCost: 4, seasonsKept: 3 },
      { year: 2025, manager: 'Jason McComb', roundCost: 5, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Nolan Arenado',
    entries: [
      { year: 2015, manager: 'David Rotatori', roundCost: 15, seasonsKept: null },
      { year: 2016, manager: 'Tim Riker', roundCost: 10, seasonsKept: null },
      { year: 2017, manager: 'Tim Riker', roundCost: 4, seasonsKept: 3 },
      { year: 2018, manager: 'Tim Riker', roundCost: 2, seasonsKept: null },
    ],
  },
  {
    playerName: 'Ronald Acuña Jr.',
    entries: [
      { year: 2019, manager: 'Jess Barron', roundCost: 8, seasonsKept: 1 },
      { year: 2020, manager: 'Jess Barron', roundCost: 3, seasonsKept: 2 },
      { year: 2022, manager: 'Jess Barron', roundCost: 1, seasonsKept: 3 },
      { year: 2024, manager: 'Jason McComb', roundCost: 1, seasonsKept: 1 },
    ],
  },
  ...
  // ── 3-season keepers ──
  {
    ...
    entries: [
      { year: 2017, manager: 'Bryan Lewis', roundCost: 15, seasonsKept: 1 },
      { year: 2018, manager: 'Bryan Lewis', roundCost: 10, seasonsKept: 2 },
      { year: 2019, manager: 'Bryan Lewis', roundCost: 5, seasonsKept: 3 },
    ],
  },
  {
    playerName: 'Anthony Rizzo',
    entries: [
      { year: 2015, manager: 'Bryan Lewis', roundCost: 15, seasonsKept: null },
      { year: 2016, manager: 'Bryan Lewis', roundCost: 10, seasonsKept: null },
      { year: 2017, manager: 'Bryan Lewis', roundCost: 5, seasonsKept: 3 },
    ],
  },
  {
    playerName: 'Bo Bichette',
    entries: [
      { year: 2020, manager: 'John Gibbons', roundCost: 21, seasonsKept: 1 },
      { year: 2022, manager: 'John Gibbons', roundCost: 16, seasonsKept: 2 },
      { year: 2023, manager: 'John Gibbons', roundCost: 11, seasonsKept: 3 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2016, manager: 'John Gibbons', roundCost: 15, seasonsKept: null },
      { year: 2017, manager: 'John Gibbons', roundCost: 10, seasonsKept: 3 },
      { year: 2018, manager: 'John Gibbons', roundCost: 5, seasonsKept: null },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2017, manager: 'Eric Mercado', roundCost: 15, seasonsKept: 1 },
      { year: 2018, manager: 'Eric Mercado', roundCost: 10, seasonsKept: 2 },
      { year: 2019, manager: 'Eric Mercado', roundCost: 5, seasonsKept: 3 },
    ],
  },
  {
    playerName: 'Giancarlo Stanton',
    entries: [
      { year: 2015, manager: 'Jess Barron', roundCost: 4, seasonsKept: null },
      { year: 2016, manager: 'Jess Barron', roundCost: 3, seasonsKept: null },
      { year: 2018, manager: 'David Rotatori', roundCost: 2, seasonsKept: 1 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2016, manager: 'Eric Mercado', roundCost: 15, seasonsKept: null },
      { year: 2017, manager: 'Eric Mercado', roundCost: 10, seasonsKept: 2 },
      { year: 2018, manager: 'Eric Mercado', roundCost: 5, seasonsKept: null },
    ],
  },
  {
    playerName: 'Jack Flaherty',
    entries: [
      { year: 2019, manager: 'Chris Herbst', roundCost: 25, seasonsKept: 1 },
      { year: 2020, manager: 'Chris Herbst', roundCost: 20, seasonsKept: 2 },
      { year: 2025, manager: 'David Rotatori', roundCost: 25, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Jacob deGrom',
    entries: [
      { year: 2018, manager: 'Matt Wayne', roundCost: 2, seasonsKept: 1 },
      { year: 2019, manager: 'Matt Wayne', roundCost: 1, seasonsKept: 2 },
      { year: 2022, manager: 'Eric Mercado', roundCost: 1, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Josh Donaldson',
    entries: [
      { year: 2015, manager: 'Harris Cook', roundCost: 10, seasonsKept: null },
      { year: 2016, manager: 'Harris Cook', roundCost: 4, seasonsKept: null },
      { year: 2017, manager: 'Harris Cook', roundCost: 2, seasonsKept: 3 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2016, manager: 'David Rotatori', roundCost: 13, seasonsKept: null },
      { year: 2017, manager: 'David Rotatori', roundCost: 8, seasonsKept: 2 },
      { year: 2018, manager: 'David Rotatori', roundCost: 3, seasonsKept: null },
    ],
  },
  {
    playerName: 'Kyle Schwarber',
    entries: [
      { year: 2016, manager: 'Chris Herbst', roundCost: 15, seasonsKept: null },
      { year: 2023, manager: 'John Gibbons', roundCost: 10, seasonsKept: 1 },
      { year: 2026, manager: 'Bryan Lewis', roundCost: 5, seasonsKept: 1 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2015, manager: 'Bryan Lewis', roundCost: 4, seasonsKept: null },
      { year: 2016, manager: 'Bryan Lewis', roundCost: 2, seasonsKept: null },
      { year: 2017, manager: 'Bryan Lewis', roundCost: 2, seasonsKept: 3 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2016, manager: 'Matt Wayne', roundCost: 8, seasonsKept: null },
      { year: 2017, manager: 'Matt Wayne', roundCost: 3, seasonsKept: 3 },
  ...
  },
  {
    ...
    entries: [
      { year: 2015, manager: 'John Gibbons', roundCost: 1, seasonsKept: null },
      { year: 2016, manager: 'John Gibbons', roundCost: 1, seasonsKept: null },
      { year: 2017, manager: 'John Gibbons', roundCost: 1, seasonsKept: 3 },
    ],
  },
  {
    ...
    entries: [
      ...
      { year: 2026, manager: 'Bryan Lewis', roundCost: 15, seasonsKept: 3 },
    ],
  },
  {
    playerName: 'Rafael Devers',
    entries: [
      { year: 2020, manager: 'Tim Riker', roundCost: 12, seasonsKept: 1 },
      { year: 2022, manager: 'Tim Riker', roundCost: 7, seasonsKept: 2 },
      { year: 2023, manager: 'Jess Barron', roundCost: 2, seasonsKept: 3 },
    ],
  },
  {
    playerName: 'Sonny Gray',
    entries: [
      { year: 2015, manager: 'Jason McComb', roundCost: 12, seasonsKept: null },
      { year: 2016, manager: 'Jason McComb', roundCost: 7, seasonsKept: null },
      { year: 2020, manager: 'Jason McComb', roundCost: 24, seasonsKept: 1 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      ...
      { year: 2025, manager: 'Harris Cook', roundCost: 19, seasonsKept: 2 },
      { year: 2026, manager: 'Harris Cook', roundCost: 14, seasonsKept: 3 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2019, manager: 'Eric Mercado', roundCost: 25, seasonsKept: 1 },
      { year: 2020, manager: 'Eric Mercado', roundCost: 20, seasonsKept: 2 },
      { year: 2022, manager: 'Eric Mercado', roundCost: 15, seasonsKept: 3 },
    ],
  },
  {
    playerName: 'Walker Buehler',
    entries: [
      { year: 2019, manager: 'Tim Riker', roundCost: 24, seasonsKept: 1 },
      { year: 2020, manager: 'Tim Riker', roundCost: 19, seasonsKept: 2 },
      { year: 2022, manager: 'Tim Riker', roundCost: 14, seasonsKept: 3 },
    ],
  },
  {
    playerName: 'Yordan Alvarez',
    entries: [
      { year: 2020, manager: 'Matt Wayne', roundCost: 24, seasonsKept: 1 },
      { year: 2022, manager: 'Matt Wayne', roundCost: 19, seasonsKept: 2 },
      { year: 2023, manager: 'Matt Wayne', roundCost: 14, seasonsKept: 3 },
    ],
  },

  // ── 2-season keepers ──
  {
    playerName: 'AJ Pollock',
    entries: [
      { year: 2016, manager: 'David Rotatori', roundCost: 15, seasonsKept: null },
      { year: 2017, manager: 'David Rotatori', roundCost: 10, seasonsKept: 2 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2022, manager: 'David Rotatori', roundCost: 24, seasonsKept: 1 },
      { year: 2023, manager: 'David Rotatori', roundCost: 19, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Andrew Benintendi',
    entries: [
      { year: 2018, manager: 'Eric Mercado', roundCost: 11, seasonsKept: 1 },
      { year: 2019, manager: 'Eric Mercado', roundCost: 6, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Andrew McCutchen',
    entries: [
      { year: 2015, manager: 'Tim Riker', roundCost: 1, seasonsKept: null },
      { year: 2016, manager: 'Tim Riker', roundCost: 1, seasonsKept: null },
    ],
  },
  {
    playerName: 'Anthony Rendon',
    entries: [
      { year: 2015, manager: 'Matt Wayne', roundCost: 15, seasonsKept: null },
      { year: 2020, manager: 'Jess Barron', roundCost: 4, seasonsKept: 1 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2019, manager: 'David Rotatori', roundCost: 14, seasonsKept: 1 },
      { year: 2020, manager: 'David Rotatori', roundCost: 9, seasonsKept: 2 },
    ],
  },
  {
  ...
  {
    playerName: 'Brian Dozier',
    entries: [
      { year: 2015, manager: 'Eric Mercado', roundCost: 13, seasonsKept: null },
      { year: 2018, manager: 'Jess Barron', roundCost: 3, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Bryan Woo',
    entries: [
      { year: 2025, manager: 'Harris Cook', roundCost: 17, seasonsKept: 1 },
      { year: 2026, manager: 'Harris Cook', roundCost: 12, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Buster Posey',
    entries: [
      { year: 2015, manager: 'Eric Mercado', roundCost: 6, seasonsKept: null },
      { year: 2016, manager: 'Eric Mercado', roundCost: 1, seasonsKept: null },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2016, manager: 'Jess Barron', roundCost: 2, seasonsKept: null },
      { year: 2017, manager: 'Harris Cook', roundCost: 3, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Corey Seager',
    entries: [
      { year: 2017, manager: 'Jess Barron', roundCost: 4, seasonsKept: 1 },
      { year: 2018, manager: 'Jess Barron', roundCost: 4, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Cristian Javier',
    entries: [
      { year: 2023, manager: 'Matt Wayne', roundCost: 22, seasonsKept: 1 },
      { year: 2024, manager: 'Matt Wayne', roundCost: 17, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Cristopher Sánchez',
    entries: [
      { year: 2025, manager: 'Chris Herbst', roundCost: 23, seasonsKept: 1 },
      { year: 2026, manager: 'Matt Wayne', roundCost: 17, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Dallas Keuchel',
    entries: [
      { year: 2016, manager: 'Jason McComb', roundCost: 15, seasonsKept: null },
      { year: 2018, manager: 'Jason McComb', roundCost: 11, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Edwin Díaz',
    entries: [
      { year: 2019, manager: 'Matt Wayne', roundCost: 8, seasonsKept: 1 },
      { year: 2023, manager: 'Eric Mercado', roundCost: 8, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Eury Pérez',
    entries: [
      { year: 2024, manager: 'Harris Cook', roundCost: 25, seasonsKept: 1 },
      { year: 2026, manager: 'Russell Berry', roundCost: 16, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Francisco Lindor',
    entries: [
      { year: 2018, manager: 'Tim Riker', roundCost: 1, seasonsKept: 1 },
      { year: 2025, manager: 'Bryan Lewis', roundCost: 4, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Garrett Crochet',
    entries: [
      { year: 2025, manager: 'Matt Wayne', roundCost: 23, seasonsKept: 1 },
      { year: 2026, manager: 'Matt Wayne', roundCost: 18, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'George Springer',
    entries: [
      { year: 2015, manager: 'Harris Cook', roundCost: 14, seasonsKept: null },
      { year: 2016, manager: 'Harris Cook', roundCost: 9, seasonsKept: null },
    ],
  },
  {
    playerName: 'Gerrit Cole',
    entries: [
      { year: 2016, manager: 'Harris Cook', roundCost: 6, seasonsKept: null },
      { year: 2019, manager: 'John Gibbons', roundCost: 6, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Gleyber Torres',
    entries: [
      { year: 2019, manager: 'Tim Riker', roundCost: 25, seasonsKept: 1 },
      { year: 2020, manager: 'Tim Riker', roundCost: 20, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Hunter Brown',
    entries: [
      { year: 2025, manager: 'David Rotatori', roundCost: 17, seasonsKept: 1 },
      { year: 2026, manager: 'David Rotatori', roundCost: 12, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Ian Desmond',
    entries: [
      { year: 2015, manager: 'Tim Riker', roundCost: 5, seasonsKept: null },
      { year: 2017, manager: 'David Rotatori', roundCost: 11, seasonsKept: 1 },
    ],
  },
  {
    ...
    entries: [
      ...
      { year: 2026, manager: 'John Gibbons', roundCost: 7, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Jackson Merrill',
    entries: [
      { year: 2025, manager: 'Tim Riker', roundCost: 25, seasonsKept: 1 },
      { year: 2026, manager: 'Russell Berry', roundCost: 16, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'James Wood',
    entries: [
      { year: 2025, manager: 'Matt Wayne', roundCost: 25, seasonsKept: 1 },
      { year: 2026, manager: 'Matt Wayne', roundCost: 20, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Javier Báez',
    entries: [
      { year: 2019, manager: 'Chris Herbst', roundCost: 16, seasonsKept: 1 },
      { year: 2020, manager: 'Chris Herbst', roundCost: 11, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Jeff McNeil',
    entries: [
      { year: 2020, manager: 'Eric Mercado', roundCost: 25, seasonsKept: 2 },
      { year: 2023, manager: 'Eric Mercado', roundCost: 25, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Josh Hader',
    entries: [
      { year: 2019, manager: 'Jason McComb', roundCost: 22, seasonsKept: 1 },
      { year: 2020, manager: 'Jason McComb', roundCost: 17, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'José Abreu',
    entries: [
      { year: 2015, manager: 'Tim Riker', roundCost: 11, seasonsKept: null },
      { year: 2016, manager: 'David Rotatori', roundCost: 6, seasonsKept: null },
    ],
  },
  {
    playerName: 'Justin Turner',
    entries: [
      { year: 2018, manager: 'Bryan Lewis', roundCost: 19, seasonsKept: 1 },
      { year: 2019, manager: 'Bryan Lewis', roundCost: 14, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Kevin Gausman',
    entries: [
      { year: 2022, manager: 'Matt Wayne', roundCost: 24, seasonsKept: 1 },
      { year: 2024, manager: 'Matt Wayne', roundCost: 5, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Lawrence Butler',
    entries: [
      { year: 2025, manager: 'John Gibbons', roundCost: 21, seasonsKept: 1 },
      { year: 2026, manager: 'John Gibbons', roundCost: 16, seasonsKept: 2 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2020, manager: 'Harris Cook', roundCost: 25, seasonsKept: 1 },
      { year: 2022, manager: 'Harris Cook', roundCost: 20, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Luis Severino',
    entries: [
      { year: 2018, manager: 'Harris Cook', roundCost: 22, seasonsKept: 1 },
      { year: 2019, manager: 'Harris Cook', roundCost: 17, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Mason Miller',
    entries: [
      { year: 2025, manager: 'Eric Mercado', roundCost: 25, seasonsKept: 1 },
      { year: 2026, manager: 'David Rotatori', roundCost: 20, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Matt Chapman',
    entries: [
      { year: 2019, manager: 'David Rotatori', roundCost: 25, seasonsKept: 1 },
      { year: 2020, manager: 'David Rotatori', roundCost: 20, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Matt Harvey',
    entries: [
      { year: 2015, manager: 'Eric Mercado', roundCost: 14, seasonsKept: null },
      { year: 2016, manager: 'Eric Mercado', roundCost: 10, seasonsKept: null },
    ],
  },
  {
    playerName: 'Max Muncy',
    entries: [
      { year: 2019, manager: 'Bryan Lewis', roundCost: 25, seasonsKept: 1 },
      { year: 2020, manager: 'Bryan Lewis', roundCost: 20, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Miguel Cabrera',
    entries: [
      { year: 2016, manager: 'Bryan Lewis', roundCost: 1, seasonsKept: null },
      { year: 2017, manager: 'Bryan Lewis', roundCost: 1, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Noah Syndergaard',
    entries: [
      { year: 2016, manager: 'Eric Mercado', roundCost: 11, seasonsKept: null },
      { year: 2017, manager: 'Eric Mercado', roundCost: 6, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Nomar Mazara',
    entries: [
      { year: 2018, manager: 'Jason McComb', roundCost: 18, seasonsKept: 1 },
      { year: 2019, manager: 'Jason McComb', roundCost: 13, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Ozzie Albies',
    entries: [
      { year: 2019, manager: 'John Gibbons', roundCost: 17, seasonsKept: 1 },
      { year: 2020, manager: 'John Gibbons', roundCost: 12, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Patrick Corbin',
    entries: [
      { year: 2019, manager: 'John Gibbons', roundCost: 19, seasonsKept: 1 },
      { year: 2020, manager: 'John Gibbons', roundCost: 14, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Pete Alonso',
    entries: [
      { year: 2020, manager: 'David Rotatori', roundCost: 17, seasonsKept: 1 },
      { year: 2022, manager: 'David Rotatori', roundCost: 11, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Rhys Hoskins',
    entries: [
      { year: 2018, manager: 'John Gibbons', roundCost: 25, seasonsKept: 1 },
      { year: 2019, manager: 'John Gibbons', roundCost: 20, seasonsKept: 2 },
    ],
  },
  {
    playerName: 'Robbie Ray',
    entries: [
      { year: 2018, manager: 'Matt Wayne', roundCost: 17, seasonsKept: 1 },
      { year: 2022, manager: 'Eric Mercado', roundCost: 12, seasonsKept: 1 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2016, manager: 'Matt Wayne', roundCost: 3, seasonsKept: null },
      { year: 2019, manager: 'Jess Barron', roundCost: 5, seasonsKept: 1 },
    ],
  },
  {
    playerName: 'Trevor Story',
    entries: [
      { year: 2019, manager: 'Jess Barron', roundCost: 13, seasonsKept: 1 },
      { year: 2020, manager: 'Jess Barron', roundCost: 8, seasonsKept: 2 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2019, manager: 'Jason McComb', roundCost: 5, seasonsKept: 1 },
      { year: 2022, manager: 'Jason McComb', roundCost: 3, seasonsKept: 1 },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { year: 2022, manager: 'Bryan Lewis', roundCost: 9, seasonsKept: 1 },
      { year: 2024, manager: 'Bryan Lewis', roundCost: 4, seasonsKept: 1 },
    ],
  },
]
...
export const RECENT_DRAFT_HISTORY: Record<string, DraftHistoryEntry> = {
  ...
  [normalizeName('Jose Ramirez')]: { year: 2025, round: 1, pick: 2, manager: 'Russell Berry' },
  ...
  [normalizeName('Trea Turner')]: { year: 2025, round: 2, pick: 19, manager: 'Russell Berry' },
  ...
  [normalizeName('Matt Olson')]: { year: 2025, round: 3, pick: 22, manager: 'Russell Berry' },
  ...
  [normalizeName('Michael King')]: { year: 2025, round: 4, pick: 39, manager: 'Russell Berry' },
  ...
  [normalizeName('Shota Imanaga')]: { year: 2025, round: 5, pick: 42, manager: 'Russell Berry' },
  ...
  [normalizeName('Marcus Semien')]: { year: 2025, round: 6, pick: 59, manager: 'Russell Berry' },
  ...
  [normalizeName('Bailey Ober')]: { year: 2025, round: 7, pick: 62, manager: 'Russell Berry' },
  ...
  [normalizeName('Edwin Diaz')]: { year: 2025, round: 8, pick: 79, manager: 'Russell Berry' },
  ...
  [normalizeName('Dylan Crews')]: { year: 2025, round: 9, pick: 82, manager: 'Russell Berry' },
  ...
  [normalizeName('Luis Robert Jr.')]: { year: 2025, round: 10, pick: 99, manager: 'Russell Berry' },
  ...
  [normalizeName('Raisel Iglesias')]: { year: 2025, round: 11, pick: 102, manager: 'Russell Berry' },
  ...
  [normalizeName('Jasson Dominguez')]: { year: 2025, round: 12, pick: 119, manager: 'Russell Berry' },
  ...
  [normalizeName('Carlos Rodon')]: { year: 2025, round: 13, pick: 122, manager: 'Russell Berry' },
  ...
  [normalizeName('Tyler Glasnow')]: { year: 2025, round: 15, pick: 142, manager: 'Russell Berry' },
  ...
  [normalizeName('Paul Goldschmidt')]: { year: 2025, round: 16, pick: 159, manager: 'Russell Berry' },
  ...
  [normalizeName('Xander Bogaerts')]: { year: 2025, round: 17, pick: 162, manager: 'Russell Berry' },
  ...
  [normalizeName('Francisco Alvarez')]: { year: 2025, round: 18, pick: 179, manager: 'Russell Berry' },
  ...
  [normalizeName('Ezequiel Tovar')]: { year: 2025, round: 19, pick: 182, manager: 'Russell Berry' },
  ...
  [normalizeName('Cristopher Sanchez')]: { year: 2025, round: 23, pick: 221, manager: 'Russell Berry' },
  ...
  [normalizeName('Brady Singer')]: { year: 2025, round: 24, pick: 236, manager: 'Russell Berry' },
  [normalizeName('Mark Vientos')]: { year: 2025, round: 25, pick: 237, manager: 'Russell Berry' },
  ...
  [normalizeName('Bobby Miller')]: { year: 2024, round: 4, pick: 37, manager: 'Russell Berry' },
  [normalizeName('Nolan Jones')]: { year: 2024, round: 6, pick: 56, manager: 'Matt Wayne' },
  [normalizeName('Joe Musgrove')]: { year: 2024, round: 6, pick: 57, manager: 'Russell Berry' },
  ...
  [normalizeName('Andres Gimenez')]: { year: 2024, round: 14, pick: 137, manager: 'Russell Berry' },
  ...
  [normalizeName('Jordan Walker')]: { year: 2024, round: 10, pick: 97, manager: 'Russell Berry' },
  ...
  [normalizeName('Starling Marte')]: { year: 2024, round: 22, pick: 214, manager: 'Russell Berry' },
  ...
  [normalizeName('DJ LeMahieu')]: { year: 2024, round: 24, pick: 231, manager: 'Russell Berry' },
  [normalizeName('Trevor Story')]: { year: 2024, round: 24, pick: 232, manager: 'Tim Riker' },
  // ── 2023 Draft (fills in players not in 2024 or 2025) ──
  [normalizeName('Shane McClanahan')]: { year: 2023, round: 7, pick: 63, manager: 'Russell Berry' },
